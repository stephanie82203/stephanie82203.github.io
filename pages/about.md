...
menu: false
title: About Me
description: Learn more about who I am and what I build
permalink: /about/
---

<!-- TOP SECTION -->
<div style="display: flex; align-items: center; gap: 40px; flex-wrap: wrap; margin-bottom: 50px;">

  <!-- LEFT: PHOTO (original Jekyll theme styling) -->
  ...
  <div style="flex: 2; min-width: 280px;">
    ...
    <h1 style="margin-top:0;">I'm Stephanie.</h1>
...
## How I Work
I learn fast, apply things even faster, and keep everything simple.
I break problems into steps, cut unnecessary work, and build processes that save time for both me and whoever uses them.
If something is inefficient, I fix it. If something is confusing, I clean it up.
...
I don’t pretend to know everything, but I don’t stay confused for long.

Outside of work, I snowboard, shuffle dance, take random photos, and try new things even when I’m clueless at first.
...
My goal is to keep growing my technical skills, sharpen my visual style, and build a portfolio that reflects both my abilities and the way I think.